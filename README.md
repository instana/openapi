...
[![Build Status](https://travis-ci.org/:instana/openapi.svg?branch=master)](https://travis-ci.org/:instana/openapi)
...
6. If you did everything correct, https://:instana.github.io/openapi/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://:instana.github.io/openapi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://:instana.github.io/openapi/ with url from the message: `Server started <url>`
