...
- **eventTypeFilters:** Filters results to the specified or a set of event type(s), such as `incident`, `issue` or `change`. By default, events of any type are returned.
